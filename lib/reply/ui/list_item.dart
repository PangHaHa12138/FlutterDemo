...
import 'package:test001/reply/details_page.dart';
import 'package:test001/reply/model/email.dart';
import 'package:test001/reply/styling.dart';
import 'package:test001/reply/ui/rounded_avatar.dart';

class ListItem extends StatelessWidget {
  const ListItem({Key? key, required this.id, required this.email, required this.onDeleted}) : super(key: key);
