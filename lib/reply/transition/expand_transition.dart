...
class ExpandItemPageTransition extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Animation<double> animation = ModalRoute.of(context)!.animation?? const AlwaysStoppedAnimation(0.0);
  ...
  double _calculateHeaderHeight(BuildContext context, String msg) {
    ...
    final TextSpan span = TextSpan(style: Theme.of(context).textTheme.displayMedium, text: msg);
