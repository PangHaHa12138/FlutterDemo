...
class EmailModel with ChangeNotifier {
  ...
  final List<Email> _emails = <Email>[
    ...
    const Email("Ali Connors", "25 minutes ago", "Brunch this weekend?", "I’ll be in your neighborhood doing errands on Saturday morning and wanted to ask if you would be up for having brunch at The Cake Facory?\n\nWould love to catch up with you!", "avatar1.jpg", "me", false, false, false),
