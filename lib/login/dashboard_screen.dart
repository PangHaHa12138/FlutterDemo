...
import 'package:test001/login/widgets.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:test001/login/constants.dart';
import 'package:test001/login/transition_route_observer.dart';
import 'package:test001/login/widgets/animated_numeric_text.dart';
import 'package:test001/login/widgets/fade_in.dart';
import 'package:test001/login/widgets/round_button.dart';
...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  Widget _buildHeader(ThemeData theme) {
    const primaryColor =Color(0xFFB39DDB);
            ...
            Row(
              ...
              children: <Widget>[
                ...
                AnimatedNumericText(
                  ...
                  controller: _loadingController!,
                  style: const TextStyle(color: Colors.lightGreenAccent,fontSize: 50),
                ),
              ],
            ),
            const Text('Account Balance', style: TextStyle(color: Colors.yellowAccent,fontSize: 20)),
          ],
        ),
      ),
    );
