...
import 'package:test001/tetris/gamer/block.dart';
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(S.of(context).points,
              style: const TextStyle(color:Colors.black,decoration:TextDecoration.none,fontSize:14,fontWeight: FontWeight.bold)),
